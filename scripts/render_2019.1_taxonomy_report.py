...
.empty{{color:var(--muted);font-style:italic}}.no-results{{padding:4rem 1rem;text-align:center;color:var(--muted)}}footer{{max-width:1240px;margin:auto;padding:0 1.25rem 2.5rem;color:var(--muted);font-size:.78rem}}
